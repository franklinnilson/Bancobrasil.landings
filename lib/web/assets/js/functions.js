...
var formSend = function(e){
    ...
    $(el).find('select, input').each(function() {
        ...
        }else if($(this).hasClass('aceite') && $('input[name=aceite]:checked').val() === undefined){

            $(this).closest('.validate').addClass('error')

        }else if($(this).hasClass('select-button') && $('#hour').val() === ''){
                    ...
                    success: function (data) {
                        ...
                        if(data.success){
                            ...
                            $(el).html(`<div class="form-error">
                                ...
                                <p>Entre em contato no horário de atendimento pelo número 0800-272-7050</p>
                                </div>
                            `)
                        }
